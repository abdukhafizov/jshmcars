...
let cars = [
    ...
    },
    {
        ...
        isBox: true,
        price: 2000,
        img: 'https://wroom.ru/i/cars2/lada_2101_1.jpg'
    },
    {
        id: Math.random(),
        mark: 'onix',
        ...
        isBox: true,
        price: 50000,
        img: 'https://www.autostrada.uz/wp-content/uploads/2019/07/chevrolet-onix-1.jpg.webp'
    },
]
...
setTimeout(() => {
    let id = +prompt('which car?')

    cars.forEach(item => {
        if(item.id === id) {

                cars = cars.filter(elem => elem.id !== id)
